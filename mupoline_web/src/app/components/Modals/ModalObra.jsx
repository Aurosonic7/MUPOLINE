                    ...
                    <h2 className="text-xl font-bold mb-6 text-center">{isEditMode ? 'Actualizar Obra' : 'Agregar Obra'}</h2>
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-3 gap-x-4 mb-4">
                                ...
                                <input className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm col-span-2" 
                                    type="text" id="title" value={title} onChange={handleTitleChange}
                                    style={{ background: '#E6E6E6', border: '0.3px solid #000000' }} required />
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-x-4 mb-4">
                                ...
                                <textarea className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm col-span-2"
                                    id="description" value={description} onChange={handleDescriptionChange}
                                    style={{ background: '#E6E6E6', border: '0.3px solid #000000' }} required
                                ></textarea>
                            </div>
