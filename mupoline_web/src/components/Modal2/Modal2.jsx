                    ...
                    <h2 className="text-xl font-bold mb-6 text-center">{isEditMode ? 'Actualizar Empleado' : 'Alta Empleado'}</h2>
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-3 gap-x-4 mb-4">
                                <label htmlFor="titulo" className="block text-sm font-medium text-gray-700 self-center col-span-1">Correo</label>
                                <input
                                    type="text"
                                    id="titulo"
                                    value={titulo}
                            ...
                            <div className="grid grid-cols-3 gap-x-4 mb-4">
                                <label htmlFor="descripcion" className="block text-sm font-medium text-gray-700 self-center col-span-1">Contraseña</label>
                                <textarea
                                    id="descripcion"
                                    value={descripcion}
                            ...
                            <div className="grid grid-cols-3 gap-x-4 mb-4">
                                <label htmlFor="descripcion" className="block text-sm font-medium text-gray-700 self-center col-span-1">Confirmar contraseña</label>
                                <textarea
                                    id="descripcion"
                                    value={descripcion}
                                    onChange={handleDescripcionChange}
